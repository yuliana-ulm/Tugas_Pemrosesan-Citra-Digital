...
- Untuk layer pertama
```octave
gambar = imread("bitYuliana.jpg");
gray = rgb2gray(gambar);

for x = 1:rows(gray)
	for y = 1:columns(gray)
		bitplane(x,y) = bitget(gray(x,y),1);
	endfor
endfor
...
for x = 1:rows(gray)
	for y = 1:columns(gray)
		bitplane(x,y) = bitget(gray(x,y),2);
	endfor
endfor
...
for x = 1:rows(gray)
	for y = 1:columns(gray)
		bitplane(x,y) = bitget(gray(x,y),3);
	endfor
endfor
...
for x = 1:rows(gray)
	for y = 1:columns(gray)
		bitplane(x,y) = bitget(gray(x,y),5);
	endfor
endfor
...
for x = 1:rows(gray)
	for y = 1:columns(gray)
		bitplane(x,y) = bitget(gray(x,y),6);
	endfor
endfor
...
for x = 1:rows(gray)
	for y = 1:columns(gray)
		bitplane(x,y) = bitget(gray(x,y),7);
	endfor
endfor
...
- ini adalah gambar asli yang belum dilakukan steganografi

<img src="/Gambar/Gambar-Tugas-6/Yuliana.jpg" width="50%" height="50%" align="center">

- ini adalah gambar hasil steganografi

<img src="/Gambar/Gambar-Tugas-6/Yuliana2.jpg" width="50%" height="50%" align="center">
